...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6 max-w-2xl mx-auto">
        <form action="<?php echo e(route('seats.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
                <label class="text-white">Ülőhely kódja</label>
                <input type="text" name="seat_number" value="<?php echo e(old('seat_number')); ?>" class="w-full border p-2 rounded">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="base_price" value="<?php echo e(old('base_price')); ?>" class="w-full border p-2 rounded">
...
<?php endif; ?>
<?php /**PATH /home/abel/Documents/school/szerveroldali/ticketing-system/resources/views/seat/create.blade.php ENDPATH**/ ?>