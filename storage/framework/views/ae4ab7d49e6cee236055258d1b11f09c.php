...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
            ...
            <form action="<?php echo e(route('ticket.scan.post')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
...
<?php endif; ?>
<?php /**PATH /home/abel/Documents/school/szerveroldali/ticketing-system/resources/views/tickets/scan.blade.php ENDPATH**/ ?>